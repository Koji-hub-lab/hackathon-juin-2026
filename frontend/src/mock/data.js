// Données simulées — Phase 1 (avant intégration backend) et repli si l'API est
// indisponible. Elles reflètent le contrat API (Section 4 du README équipe).
...
export const mockPredictions = [
  { warehouseId: 1, warehouseName: "Douala Central", currentStock: 847, capacity: 1000, fillPercent: 85, daysUntilRupture: 49, confidence: 77, trend: "baisse", recommendation: "Stock suffisant" },
  { warehouseId: 2, warehouseName: "Yaoundé Nord", currentStock: 312, capacity: 500, fillPercent: 62, daysUntilRupture: 25, confidence: 72, trend: "stable", recommendation: "Surveiller — commander sous 1 semaine" },
  { warehouseId: 3, warehouseName: "Bafoussam Est", currentStock: 95, capacity: 400, fillPercent: 24, daysUntilRupture: 9, confidence: 91, trend: "stable", recommendation: "Réapprovisionner dans les 48h" },
  { warehouseId: 4, warehouseName: "Garoua Logistik", currentStock: 560, capacity: 800, fillPercent: 70, daysUntilRupture: 65, confidence: 74, trend: "monte", recommendation: "Stock suffisant" },
];
...
// Inventaire consolidé dérivé des mocks (warehouses + produits associés).
export const mockInventory = mockWarehouses.map((w) => {
